...
public class ActualizarContactoActivity extends AdminContactsActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        this.setContentView(R.layout.updatecontact);
        ...
        FloatingActionButton botonActualizar = findViewById(R.id.nextActuCont);
    ...
    public void cargarContactos(FirebaseFirestore db, View v, ArrayList<Contacto> contactos){
        ...
        db.collection("contactos")
                ...
                .addOnCompleteListener(task -> {
                    ...
                    funcionActualizarContacto(contactos, db);
                });
    }

    //funcion para recoger los datos y hacer la llamada a la funcion que actualiza el contacto
    /*
     * @param   contactos   el arraylist con los contactos recogidos de la base de datos
     * @param   db          la instancia de la base de datos
     */
    public void funcionActualizarContacto(ArrayList<Contacto> contactos, FirebaseFirestore db){
        //boton para cuando ha metido los valores y crea el usuario
        FloatingActionButton botonActualizar = findViewById(R.id.nextActuCont);
        botonActualizar.setOnClickListener(view -> {
            //recoge los datos de los campos
            EditText email = findViewById(R.id.NuevoEmailActuCont);
            EditText nombre = findViewById(R.id.NuevoNombreActuCont);
            EditText apellido = findViewById(R.id.NuevoApellidoActuCont);
            EditText telefono = findViewById(R.id.NuevoTelefonoActuCont);
            ...
            for (int i=0; i<contactos.size(); i++){
                if(nuevoEmail.equals(contactos.get(i).getEmail())){
                    ...
                    Contacto contacto = new Contacto(contactos.get(i).getId(), nuevoNombre, nuevoApellido, nuevoTelefono, nuevoEmail);
